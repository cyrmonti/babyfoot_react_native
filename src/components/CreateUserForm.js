...
import { createUser, resetBabyfootList } from '../actions'
...
class CreateUserForm extends React.Component {
    ...
    onPressButton() {
        ...
        else if (isNaN(parseInt(department))) {
            this.setState({ error: 'Department format incorrect'})
        }
        else {
            this.props.createUser({ email, password, pseudo, name, firstname, department: parseInt(department) });
...
export default connect(null, { createUser, resetBabyfootList })(CreateUserForm);